...
$System_Config['appName'] = 'Marisn-SSR';             //站点名称
$System_Config['baseUrl'] = '';            // 站点地址
$System_Config['timeZone'] = 'PRC';        // PRC 天朝时间  UTC 格林时间
$System_Config['pwdMethod'] = 'md5';       // 密码加密   可选 md5,sha256
$System_Config['salt'] = '';               // 密码加密用，从旧版升级请留空
$System_Config['theme']    = 'ms';   // 主题
...
$System_Config['f2fpay_activate_key']=''; 
...
#用户等级过期时间，在注册时设置。（小时）
$System_Config['user_class_expire_default']='2';

#用户注册等级，在注册时设置。
$System_Config['user_class_default']='9';

#用户注册客户端数量限制，0为不限制
$System_Config['user_conn']='2';


#用户注册速度默认限制，0为不限制
$System_Config['user_speedlimit']='2';


#邀请新用户获得流量奖励，单位G
$System_Config['invite_gift']='2';

#新用户通过私人邀请链接注册，获得奖励金额（鼓励消费）
$System_Config['invite_get_money']='10';
